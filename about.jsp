...
<body class="about-page">
    ...
    <section class='page-banner'>
        <div class='container'>
            <h1 class="text-gradient display-3 fw-bold mb-0" data-aos='fade-right'>About Us</h1>
        </div>
    </section>
        ...
        <div class='container'>
            <div class='row align-items-center'>
                ...
                <div class='col-lg-6' data-aos='fade-left'>
                    <img src="./assets/images/logo/weaver-leaders.svg" class="img-fluid mb-3" alt="weaver"
                        style="max-width: 250px;width: 100%;" />
                    <h2 class="display-5 text-gradient fw-bold">About Us</h2>
                    <p>
                        <strong>We the Weaver Leaders</strong> is a community-driven platform dedicated to preserving,
                        promoting, and empowering the rich heritage of weaving and textile craftsmanship. Rooted in the
                        vision, <em>"Let Us Cherish Weaving, Let Us Foster Weaving,"</em> we strive to create a
                        sustainable
                        future for weaving communities while honoring the traditions passed down through generations.
                    </p>

                    <p>
                        Through collaboration, innovation, and knowledge sharing, we work to bridge the gap between
                        traditional weaving practices and modern market demands. We encourage the adoption of new
                        techniques, sustainable production methods, and digital opportunities that help artisans
